...
if( !class_exists('Fastshop_Mailchimp') ){
	class Fastshop_Mailchimp{
		public $plugin_uri;
		private $options;
        ...
        <div class="updated">
            <p><?php 
                printf( 
                    __('Please enter Mail Chimp API Key in <a href="%s">here</a>', 'fastshop-toolkit' ),
		...
		public function scripts(){
			wp_enqueue_script( 'fastshop-mailchimp', FASTSHOP_TOOLKIT_URL. '/includes/classes/mailchimp/js/mailchimp.min.js', array( 'jquery' ), '1.0', true );
			wp_localize_script( 'fastshop-mailchimp', 'fastshop_mailchimp', array(
				'ajaxurl'  => admin_url('admin-ajax.php'),
				'security' => wp_create_nonce( 'fastshop_mailchimp' ),
	        ) );
		}
		...
		public function submit_mailchimp_via_ajax() {
			...
			$api_key = "";
			$list_id = "";
			$success_message = esc_html__('Your email added...','fastshop-toolkit');
			...
			$response['message'] = esc_html__( 'Failed', 'fastshop-toolkit' );
