	...
	class Ovic_Import_Data
	{
                ...
                <div class="header">
                    <div class="main">
                        <div class="options theme-browser">
                            <div class="option content-import <?php echo ( $this->options == 0 ) ? '' : 'done-import'; ?>">
                                <div class="inner">
                                    <div class="preview">
		...
		public function include_importer_classes()
		{
			...
			if ( !class_exists( 'Ovic_WP_Import' ) ) {
				if ( file_exists( dirname( __FILE__ ) . '/vendor/wordpress-importer.php' ) ) {
			...
			if ( !empty( $plugins ) ) {
				foreach ( $plugins as $plugin ) {
					if ( $tgm->is_plugin_active( $plugin['slug'] ) ) {
						continue;
					} else if ( $tgm->is_plugin_installed( $plugin['slug'] ) ) {
						// Active Plugin
