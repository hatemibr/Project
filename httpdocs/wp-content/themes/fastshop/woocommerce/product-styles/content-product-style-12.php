...
<?php add_action( 'woocommerce_shop_loop_item_title', 'woocommerce_template_loop_price', 20 ); ?>
<div class="product-inner">
    ...
    <div class="group-content equal-elem">
		<?php
		/**
...
<?php remove_action( 'woocommerce_shop_loop_item_title', 'woocommerce_template_loop_price', 20 ); ?>
